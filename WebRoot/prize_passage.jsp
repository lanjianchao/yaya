...
con.close();
               ...
               <a href="prize_passage.jsp?showPage=1">[首页</a> | <a href="prize_passage.jsp?showPage=<%=showPage-1 %>" >上一页</a> | <a href="prize_passage.jsp?showPage=<%=showPage+1 %>" >下一页</a> | <a href="prize_passage.jsp?showPage=<%=pageCount %>" >末页</a>] 转至
               <form action="prize_passage.jsp">
