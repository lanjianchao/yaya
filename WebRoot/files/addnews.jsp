    ...
    <td class="CPanel">
		...
		<TR>
			<TD width="100%">
				...
				<legend>创建新闻</legend>
                    <s:form  id="form1" name="form1" action="news.action" method="post" enctype="multipart/form-data">
					   <table border="0" cellpadding="2" cellspacing="1" style="width:100%">
					 
					       <tr>
					          <td nowrap align="right" width="13%">新闻标题:</td>
					          <td width="41%"><input name="ne.newsTheme"  id="newsTheme" class="text" style="width:250px" type="text" size="40" />

					       </tr>
					        <tr>
					         <td nowrap align="right" height="120px">新闻内容：</td>
					          <td >
				<textarea cols="80"  id="editor1" name="ne.newsContent" rows="20"></textarea>
