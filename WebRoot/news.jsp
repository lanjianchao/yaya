...
%>
                        ...
                        <li>
                            <a href="upNews.action?newsId=<%=rs.getInt(1) %>"><%=rs.getString(2) %></a>
...
con.close();
               ...
               <a href="news.jsp?showPage=1">[首页</a> | <a href="news.jsp?showPage=<%=showPage-1 %>" >上一页</a> | <a href="news.jsp?showPage=<%=showPage+1 %>" >下一页</a> | <a href="news.jsp?showPage=<%=pageCount %>" >末页</a>] 转至
